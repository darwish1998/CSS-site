...
var names = ['Ali','Abdi','Hussain', 'cade','Darwish'];

function booterLunch() {
   var randomPeople = names.length;
   var randomPosition = Math.floor(Math.random()*randomPeople);
